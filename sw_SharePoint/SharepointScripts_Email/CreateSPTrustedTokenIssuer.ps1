...
.\CreateSPTrustedTokenIssuer.ps1 -identifierClaimType "Email" -certPath "\\cead.prd\data\USERS\MIA0\fz6302\USRDATA\Documents\SharepointScripts\okta.cert" -realm "urn:okta:sharepoint:exkdojqhp1GZxLA520h7" -signInURL "https://poc-st-assurant.oktapreview.com/app/sharepoint_onpremise/sso/wsfed/passive" -skipCreatingTrustedRootAuthority
