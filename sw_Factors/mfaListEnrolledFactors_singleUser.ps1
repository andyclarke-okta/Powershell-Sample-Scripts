#list enrolled factors single user
#site config
$org = "https://xxxxxxxxxxxxx.okta.com"
$token="xxxxxxxxxxxx-xxxxxxxxxxxxxxxxxxx"
...
##############################################
#API parameters
$uri2 = "$org/api/v1/users/" + $OktaId + "/factors"
